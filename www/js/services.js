...
.factory('LaggingSkills', function() {
  ...
  var laggingSkills = [
    ...
    { name : "lagging_skill_2", description: "Difficulty doing things in a logical sequence or prescribed ord", id:2 },
    { name : "lagging_skill_3", description: "Difficulty persisting on challenging or tedious tas", id:3 },
    ...
    { name : "lagging_skill_10", description: "Chronic irritability and/or anxiety significantly impede capacity for problem-solving or heighten frustratio", id:10 },
    { name : "lagging_skill_11", description: "Difficulty seeing “grays”/concrete, literal, black & white, thinking", id:11 },
    { name : "lagging_skill_12", description: "Difficulty deviating from rules, routine", id:12 },
    ...
    { name : "lagging_skill_22", description: "Difficulty appreciating how his/her behavior is affecting othe", id:22 },
