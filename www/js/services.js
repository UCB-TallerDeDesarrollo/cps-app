  ...
  var helpCategoriesForStep1 = [
    {name : "help_category_01" , description : "El niño no está hablando", image: "category_1.png",id:1,
      topics: [
        ...
        {name: "topic_02", description: "¿Tal vez estás usando la Emergencia B (en el momento en que el niño ya está molesto) en lugar de Proactive B?", id:"2",
          contents: [
        ...
        {name: "topic_05", description: "Tal vez el o ella necesita que el problema este dividido en sus componentes:", id:"5",
          contents: [
        ...
        {name: "topic_07", description: "Tal vez él/ella no encuentra las palabras para decirtelo", id:"7",
          contents: [
