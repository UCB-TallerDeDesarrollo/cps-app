angular.module('starter.services').factory('HelpInformationFactory', function() {
  ...
  var step1Help = [
    ...
    },
    {
      ...
      description : "My kid is too young to do CPS",
    ...
    },
    {
      ...
      description : "The kid talked but I don’t know what to do with what s/he said",
  ...
  var faq = [
    ...
    {
      question: "You say that this model doesn’t require that adults suspend all of their expectations so a kid won’t exhibit challenging behavior. Care to say more about that?",
